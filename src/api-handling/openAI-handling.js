...
function getAIResponse(input) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, configuration, openai, completion, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    completion = _a.sent();
                    return [2 /*return*/, completion.data.choices[0].message.content || 'No response generated'];
                case 3:
                    error_1 = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, getAIResponse("What's the capital of France?")];
                case 1:
                    response = _a.sent();
